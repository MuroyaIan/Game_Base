...
public:
	...
	struct MESH_DATA
	{
		...
		std::vector<std::string> aTex_Normal;					//テクスチャ：ノーマルマップ
		std::vector<std::string> aTex_Displacement;				//テクスチャ：視差マップ
		...
		std::vector<LAYER_TEX_DATA> aLayerTex_Normal;
		std::vector<LAYER_TEX_DATA> aLayerTex_Displacement;		//レイヤテクスチャ
		...
		MESH_DATA() noexcept :
			...
			aTex_Ambient(0), aTex_Diffuse(0), aTex_Emissive(0), aTex_Transparent(0), aTex_Specular(0), aTex_Shininess(0), aTex_Normal(0), aTex_Displacement(0),
			aLayerTex_Ambient(0), aLayerTex_Diffuse(0), aLayerTex_Emissive(0), aLayerTex_Transparent(0), aLayerTex_Specular(0), aLayerTex_Shininess(0), aLayerTex_Normal(0), aLayerTex_Displacement(0),
